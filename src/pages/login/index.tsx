...
function LoginPage() {
    ...
    const validationSchema = Yup.object().shape({
        loginName: Yup.string().required('Hãy nhập tên tài khoản hoặc email'),
                        ...
                        <div className="card-body">
                            ...
                            <div className="app-brand justify-content-center">
                                <a href="index.html" className="app-brand-link gap-2">
                                    ...
                                    <span className="app-brand-text demo text-body fw-bolder">Flash</span>
                                </a>
                            </div>
                            {/* <!-- /Logo --> */}
                            ...
                            <form id="formAuthentication" className="mb-3" action="index.html" method="POST">
                                ...
                                <div className="mb-3">
                                    <button className="btn btn-primary d-grid w-100"  onClick={handleSubmit(onSubmit)}>Đăng nhập</button>
                                </div>
                            </form>
