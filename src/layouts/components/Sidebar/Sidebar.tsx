...
export default function Sidebar() {
    ...
    useEffect(() => {
        // const container = document.querySelector('#scroll_menu');

        const ps = new PerfectScrollbar('#scroll_menu', {
            ...
            <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme" >
                <div className="app-brand demo">
                    <a style={{cursor: 'pointer'}} onClick={() => navigate('/')} className="app-brand-link">
                        ...
                        <span className="app-brand-text demo menu-text fw-bolder ms-2">Flash</span>
                    </a>
                ...
                <ul id="scroll_menu" className="menu-inner py-1" style={{maxHeight: '100vh'}}>
                    ...
                    <li className={`menu-item ${openItem == 'CREDIT' ? 'open': ''}`}>
                        <a href="#" onClick={(e) => {e.preventDefault(); setOpenItem('CREDIT')}} className="menu-link menu-toggle">
                    ...
                    <li className={`menu-item ${openItem == 'CLASS' ? 'open': ''}`}>
                        <a href="#" onClick={(e) => {e.preventDefault(); setOpenItem('CLASS')}} className="menu-link menu-toggle">
                    ...
                    {/* <!-- Components --> */}
                    <li className="menu-header small text-uppercase"><span className="menu-header-text">Tài khoản</span></li>
                    {/* <!-- User interface --> */}
                    <li className="menu-item">
                        <a href="#" className="menu-link">
